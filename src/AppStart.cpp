...
void App::Start() {
    ...
    m_Giraffe = std::make_shared<Character>(GA_RESOURCE_DIR"/Image/Character/RedDiamonds.png");
    ...
    std::vector<std::string> countImages = {
    ...
    m_Ball = std::make_shared<AnimatedCharacter>(countImages);
    m_Ball->SetZIndex(10);
    m_Ball->SetPosition({ 180.f, -20.f });
