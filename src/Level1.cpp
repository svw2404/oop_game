...
void App::BuildLevel1() {
    ...
    const std::vector<SolidRect> perimeterBlocks = {
        ...
        // Seal the inside corner where the water-basin ramp meets the upper block.
        ImageRectToWorldRect(1764.0f, 973.0f, 1767.0f, 1032.0f),
        ...
        ImageRectToWorldRect(1469.0f, 1360.0f, 1477.0f, 1395.0f),
        ImageRectToWorldRect(1475.0f, 1344.0f, 1494.0f, 1395.0f),
        ImageRectToWorldRect(1475.0f, 1378.0f, 1529.0f, 1395.0f),
        ImageRectToWorldRect(1529.0f, 1372.0f, 1539.0f, 1395.0f),
    ...
    m_Slopes = {
        ...
        {ImagePointToWorldPoint(1712.0f, 1013.0f), ImagePointToWorldPoint(1767.0f, 973.0f)},
