...
private:
    ...
    std::shared_ptr<Character> m_Level4ChainPlatformTop;
    std::shared_ptr<Character> m_Level4ChainPlatformBottom;
    std::shared_ptr<Character> m_Level4ChainTop;
    std::shared_ptr<Character> m_Level4ChainBottom;
    std::shared_ptr<Character> m_Level4ChainConnectTop;
    ...
    SolidRect m_Level4ChainPlatformTopRestRect;
    ...
    bool m_HasLevel4ChainPlatforms = false;
    bool m_HasLevel4ChainPlatformTop = false;
